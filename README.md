...
- **Enrollment Tracking**: Monitor student enrollment status and course registrations
- **Grade Management**: Record and calculate student grades and GPA
- **Attendance Tracking**: Track and report student attendance records
...
1. Clone the repository:
   ```bash
   git clone https://github.com/vippium/Student-Management-System.git
   ```
